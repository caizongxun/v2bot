#!/usr/bin/env python3
"""
SSL Hybrid v3 - 從現有 HF 數據集下載
從 models_v1/ 子資料夾中下載模型
"""
...
if use_real_model:
    ...
    print("\n檔案信息:")
    print(f"  數據集: {HF_REPO}")
    print(f"  位置: {MODEL_SUBFOLDER}/")
    print(f"  Model params: {model.count_params():,}")
    print(f"  Features: {len(feature_names)}")
    
else:
    print("❌ 檔案載入失敗。事項:")
    print("  1. 確認檔案已上傳到 HuggingFace")
    print("  2. 確認子資料夾名稱是 models_v1")
    print("  3. 確認網絡連接")
    print(f"\n槛上訪問:")
